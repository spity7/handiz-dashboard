...
const EditCourse = () => {
  ...
  const actionsLocked = reorderMode || savingReorder
  ...
  return (
    <>
      ...
      <Card className={`course-curriculum-card mb-4 ${reorderMode ? 'course-curriculum-card--reorder' : ''}`}>
          ...
          <div className="course-curriculum-header">
            ...
            {!reorderMode && (
              <div className="course-curriculum-header__actions">
                <button type="button" className="course-curriculum-header__btn" disabled={!curriculum.length} onClick={startReorder}>
      ...
      <Modal show={showLessonModal} onHide={() => !savingLesson && setShowLessonModal(false)} size="lg">
        <Modal.Header closeButton>
